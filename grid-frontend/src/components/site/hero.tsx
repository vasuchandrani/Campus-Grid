...
import { ArrowRight, Building2, GraduationCap, IdCard, Newspaper, ShieldCheck, Users } from "lucide-react";
    ...
    <section className="relative overflow-hidden px-5 pt-16 pb-20 sm:pt-24 sm:pb-28">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        >
          ...
          <span className="inline-flex items-center gap-1.5">
            <Building2 className="size-3.5" /> Multi-college architecture
          </span>
        </motion.div>
      </div>
      ...
      >
        <div className="glass-panel rounded-3xl p-6 shadow-lift sm:p-10">
          <div className="flex flex-col items-center gap-4">
            <NodeCard icon={Building2} title="Your College" sub="Registered once — issued a CampusGrid ID" wide />
            <Connector />
            <div
              className="w-full rounded-2xl px-6 py-5 text-center text-primary-foreground shadow-soft"
              style={{ background: "var(--gradient-hero)" }}
            >
              <p className="text-sm font-semibold tracking-wide uppercase opacity-80">CampusGrid Core</p>
...
function BranchingConnector2() {
  return (
    <div className="relative w-full">
      {/* Top stem from CampusGrid Core */}
      <div className="mx-auto h-3.5 w-px bg-border" />
      {/* Horizontal connector line linking column 1 and column 2 centers */}
      <div className="relative w-full">
        <div className="absolute top-0 left-[calc(25%-0.1875rem)] right-[calc(25%-0.1875rem)] hidden h-px bg-border sm:block" />
        <div className="grid w-full gap-3 sm:grid-cols-2">
